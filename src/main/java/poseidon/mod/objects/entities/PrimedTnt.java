...
public class PrimedTnt extends Entity {
    ...
    public PrimedTnt(World worldIn)
    {
        super(worldIn);
        this.fuse = 200;
    ...
    public PrimedTnt(World worldIn, double x, double y, double z, EntityLivingBase igniter)
    {
        this(worldIn);
    ...
    {
        this.dataManager.register(FUSE, Integer.valueOf(200));
    }
