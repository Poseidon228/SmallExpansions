...
public class Spit extends CustomEntityThrowable implements IProjectile {
	
	public EntityPlayer owner;
    private NBTTagCompound ownerNbt;

    public Spit(World worldIn)
    {
        super(worldIn);
    }

    public Spit(World worldIn, EntityPlayer player)
    {
        super(worldIn);
        this.owner = player;
    ...
    public Spit(World worldIn, double x, double y, double z, double p_i47274_8_, double p_i47274_10_, double p_i47274_12_)
    {
        super(worldIn);
        	...
        	
        {
            ...
            worldIn.spawnParticle(EnumParticleTypes.FLAME, x, y, z, p_i47274_8_ * d0, p_i47274_10_, p_i47274_12_ * d0);
        }
...
//
    ...
    public void onHit(RayTraceResult p_190536_1_)
    {
        ...
        {
            p_190536_1_.entityHit.attackEntityFrom(DamageSource.causeIndirectDamage(this, this.owner).setProjectile(), 10.0F);
        }
    ...
    private void restoreOwnerFromSave()
    {
        if (this.ownerNbt != null && this.ownerNbt.hasUniqueId("OwnerUUID"))
        {
            ...
            for (EntityPlayer player : this.world.getEntitiesWithinAABB(EntityPlayer.class, this.getEntityBoundingBox().grow(15.0D)))
            {
