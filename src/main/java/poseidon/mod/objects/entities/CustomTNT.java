...
public class CustomTNT extends EntityTNTPrimed {
	 ...
	 private static final DataParameter<Integer> FUSE = EntityDataManager.<Integer>createKey(EntityTNTPrimed.class, DataSerializers.VARINT);
	    ...
	    public CustomTNT(World worldIn)
	    {
	        super(worldIn);
	        this.fuse = 80;
	    ...
	    public CustomTNT(World worldIn, double x, double y, double z, EntityLivingBase igniter, int fuse)
	    {
	        this(worldIn);
